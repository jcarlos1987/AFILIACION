<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterPersonal.master" AutoEventWireup="true" CodeFile="BanSalDptoPrnal.aspx.cs" Inherits="Casuistica_BanSalDptoPrnal" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="menu" Runat="Server">
    ...
    <li>
        ...
        <ul class="nav nav-second-level collapse in">  
            <li>
                <a  href="Depto_Perso.aspx"><i class="fa fa-envelope-o fa-spin"></i>Bandeja de Entrada</a>
            </li>
            <li>
                <a class="active-menu" href="BanSalDptoPrnal.aspx"><i class="fa fa-sign-out fa-spin"></i>Bandeja de Salida</a>
            </li> 
        </ul>
    </li>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="row">
                    <div class="col-md-12">
                        ...
                        <h1 class="page-head-line" style="font-size:15px;">Casuistica \ Departamento de personal \ BANDEJA DE SALIDA</h1>
                        <br />
                    </div>
                </div>
     ...
     <div class="row text-center pad-row">
         ...
         <%String strConnString = ConfigurationManager.ConnectionStrings["AfiliacionConnectionString"].ConnectionString;
           ...
           SqlCommand command = new SqlCommand("SELECT [id],[tipo],[fecha],[Ciclo],[Fecha_Carga],[Envio_Cl],[Envio_ST],[Envio_P],[No_Regis] FROM [Afiliacion].[dbo].[Crtl_SCAC] WHERE [Envio_ST] IN(1,0) AND [tipo]= 'SCAC-10' ORDER BY [Fecha_Carga]  DESC", conn);
           conn.Open();
             ...
             <div class="col-md-4">
                 <%if (reader.GetString(1).Trim() == "SCAC-09")
                   ...
                   if (reader.GetInt32(7) == 0)
                   {
                       ...
                       {
                           Response.Write("<a href='ValEnvDptoPrsnal.aspx?id=" + reader.GetInt32(0) + "' class='btn btn-success btn-block btn-lg adjust-border-radius'>VALIDAR</a>");
                       }
                       else if (Porcentaje(reader.GetString(3), reader.GetString(1)) != 100)
                       {
                           Response.Write("<a href='#' class='btn btn-success btn-block btn-lg adjust-border-radius' disabled='disabled'>Pendiente</a>");
                       }
                   }
                   else if (reader.GetInt32(7) == 1)
                   {
