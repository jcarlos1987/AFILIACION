<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterSaludTrab.master" AutoEventWireup="true" CodeFile="GridScac09.aspx.cs" Inherits="Casuistica_GridScac09" %>
     ...
     <asp:Panel ID="PanelMostrarMsj" runat="server">
         ...
         <h4>  <strong>Información del Mensaje</strong></h4>
           ...
           <a href="#" class="list-group-item">
             ...
             <a href="#" class="list-group-item">
                                        <i class="fa fa-calendar-check-o"></i>  
             <b>Fecha de Extracción del SCAC:</b> <asp:Label ID="Label8" runat="server" Text=""></asp:Label>
             </a>
             <a href="#" class="list-group-item">
