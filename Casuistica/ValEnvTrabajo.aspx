<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterSaludTrab.master" AutoEventWireup="true" CodeFile="ValEnvTrabajo.aspx.cs" Inherits="Casuistica_ValEnvTrabajo" %>
       ...
       <div class="table-responsive">
                                    ...
                                    <asp:GridView ID="GridView1" Visible="false" CssClass="gridView table table-responsive" HeaderStyle-CssClass="gridViewHeader" PagerStyle-CssClass="gridViewPaginacion" AutoGenerateColumns="false" AllowPaging="true" runat="server" PageSize="15" OnPageIndexChanging="GridView1_PageIndexChanging">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Fec_Extraccion"  SortExpression="Fecha_Extrac" HeaderText="Fecha Extrac."><ItemStyle ForeColor="Black" HorizontalAlign="Center" Width="20px" /></asp:BoundField>
