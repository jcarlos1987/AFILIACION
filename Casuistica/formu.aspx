<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterPersonal.master" AutoEventWireup="true" CodeFile="formu.aspx.cs" Inherits="Casuistica_formu" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="row">
                    <div class="col-md-12">
                        ...
                        <h1 class="page-head-line" style="font-size:17px;">CASUISTICA \ DEPARTAMENTO DE PERSONAL \ ACTUALIZAR REGISTROS</h1>
                        <br />
                    </div>
                </div> 
                        ...
                        <div class="panel-body">
                           ...
                           <div class="col-md-6">
                            <div class="form-group"> 
				                  	...
				                  	<div class="input-group" id="id_folio_error" runat="server">				                  		 
                              ...
                              <div class="col-md-6">             
                                  <div class="form-group"> 
				                  	...
				                  	<div id="id_clav_doc" runat="server" class="input-group">				                  		 
                            ...
                            <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">Nombre del Asegurado</label>
                                         <div id="id_nom_aseg" runat="server" class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-user"></i></span>    
                          ...
                          <label class="control-label">Curp</label>
                                        <div id="id_curp" runat="server" class="input-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group"> 
				                  	...
				                  	<div id="id_reg_pat" runat="server" class="input-group">				                  		 
                             ...
                             <div class="col-md-6">
                                 <div class="form-group"> 
				                  	...
				                  	<div id="id_fecha_inic" runat="server" class="input-group">				                  		 
                                ...
                                <div class="form-group has-feedback">
                                           ...
                                           <div id="id_tr" runat="server" class="input-group">
                             ...
                             <div class="col-md-6">
                                 <div class="form-group"> 
				                  	...
				                  	<div id="id_cs" runat="server" class="input-group">				                  		 
                            ...
                            <div class="col-md-6">
                                 <div class="form-group"> 
                                     ...
                                     <div id="id_dias_sub" runat="server" class="input-group">
                            ...
                            <div class="col-md-6">
                                 <div class="form-group">
                                     <label class="control-label">Porc Inc</label>
                                       <div id="id_porc_inc" runat="server" class="input-group">
                                 ...
                                 <div class="col-md-6">
                                     <div class="form-group">
                                            <label class="control-label">Fecha de Término</label>
                                             <div id="id_fecha_termino" runat="server" class="input-group">
                                  ...
                                  <div class="col-md-6">
                                      <div class="form-group">
                                       ...
                                       <div id="id_del_ori" runat="server" class="input-group">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div id="id_umf" runat="server" class="input-group">
                           ...
                           <div class="form-group has-feedback">
                             ...
                             <div class="col-md-6">
                                 <div class="form-group">
                                     ...
                                     <div id="id_folio" runat="server" class="input-group">
                                ...
                                <div id="id_cto_pag" runat="server" class="input-group">
                             ...
                             <div class="col-md-6">
                                 <div class="form-group">
                                  ...
                                  <div id="id_tipo_mov_ajust" runat="server" class="input-group">
