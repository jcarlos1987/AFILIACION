<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterPersonal.master" AutoEventWireup="true" CodeFile="ValEnvDptoPrsnal.aspx.cs" Inherits="Casuistica_ValEnvDptoPrsnal" %>
       ...
       <div class="table-responsive">
                                    ...
                                    <asp:GridView ID="GridView1" Visible="false" CssClass="gridView table table-responsive" HeaderStyle-CssClass="gridViewHeader" PagerStyle-CssClass="gridViewPaginacion" AutoGenerateColumns="false" AllowPaging="true" runat="server" PageSize="15" OnPageIndexChanging="GridView1_PageIndexChanging">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Observa"  SortExpression="Observa" HeaderText="Observación"><ItemStyle ForeColor="Black" HorizontalAlign="Left" Width="20px" /></asp:BoundField>
