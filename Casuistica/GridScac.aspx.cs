...
public partial class Casuistica_GridScac : System.Web.UI.Page
{
    ...
    public void Consulta()
    {
        ...
        try
        {
            ...
            SqlCommand Comando = new SqlCommand("SELECT [id],[tipo],[fecha],[Ciclo],[Fecha_Carga],[No_Regis],[mensaje],[leer],[Fech_Envio] FROM [Afiliacion].[dbo].[BandeDptoPrsonal] WHERE [id]=" + Convert.ToInt32(Request.Cookies["ID_DPTO_PRSNAL"].Value) + "", conn);
    ...
    public void Grid()
    {
        ...
        if (Label5.Text.Trim() == "SCAC-10")
        {
            query = "SELECT [id],[Fecha_Carga],[Folio_Error],[Cve_Docto],[NSS],[Registro_Pat],[Fecha_Inicio],[TR],CONVERT(FLOAT,[CS])[CS],[Dias_Sub],[Folio_Docto],[Porc_Inc],[Fecha_Termino],[Deleg_Orgn],[UMF],[Codigo_Error],[Codigo_Error2]" +
                    ",[Codigo_Error3],[Codigo_Error4],[Codigo_Error5],[Nombre_Asegurado],[CURP],[Cto_Pag],[Tipo_Mto_Aju],[Fecha_Extrac],[Tipo],[Ciclo],[status] FROM [Afiliacion].[dbo].[UPD_SCAC-10] WHERE [Tipo]='" + Label5.Text.Trim() + "' AND [Ciclo]='" + Label7.Text.Trim() + "'";
        }
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Response.Cookies["ID_SCAC10"].Value = Convert.ToString(id);
        Response.Redirect("formu.aspx");
    }
    protected void Cancelar_Click(object sender, EventArgs e)
    {
        Response.Redirect("Depto_Perso.aspx");
    }
}