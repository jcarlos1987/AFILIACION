...
public partial class Casuistica_Depto_Perso : System.Web.UI.Page
{
    ...
    public void Consulta()
    {
        ...
        query = "SELECT [id],[tipo],[fecha],[Ciclo],[Fecha_Carga],[No_Regis],[mensaje],[leer],CASE WHEN DATEDIFF(SECOND, [Fech_Envio],GETDATE()) < 60 THEN 'Hace ' +CONVERT(NVARCHAR(50),  DATEDIFF(SECOND, [Fech_Envio],GETDATE())) + ' Segundos' " +
          ...
          "END [Envio], [Fech_Envio] FROM [Afiliacion].[dbo].[BandeDptoPrsonal] ORDER BY [Fech_Envio] DESC";
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        using (SqlConnection conn1 = new SqlConnection(strConnString))
        {
            try
            {
                ...
                String sen = null;
                int resul;
                sen = "UPDATE [Afiliacion].[dbo].[BandeDptoPrsonal] SET [leer] = @leer WHERE [id]=" + Convert.ToInt32(id) + "";
        ...
        Response.Cookies["ID_DPTO_PRSNAL"].Value = Convert.ToString(id);
