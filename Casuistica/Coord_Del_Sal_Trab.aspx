<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterSaludTrab.master" AutoEventWireup="true" CodeFile="Coord_Del_Sal_Trab.aspx.cs" Inherits="Casuistica_Coord_Del_Sal_Trab" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <div class="row">
                    <div class="col-md-12">
                        ...
                        <h1 class="page-head-line" style="font-size:15px;">Casuistica \ Coordinación Delegacional de Salud en el Trabajo \ bandeja de entrada</h1>
                        <br />
                    </div>
                </div>
         ...
         <div class="table-responsive">
             <asp:GridView ID="GridView1" CssClass="table" HeaderStyle-CssClass="gridViewHeader" DataKeyNames="id" runat="server" PagerStyle-CssClass="gridViewPaginacion" AllowPaging="true" AutoGenerateColumns="false" OnRowDataBound="GridView1_RowDataBound" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="14">
                 <Columns>
                     ...
                     <asp:BoundField DataField="leer" HeaderText=""><ItemStyle ForeColor="Black" Font-Size="0px" Width="5px" /></asp:BoundField>
                 </Columns>
                  <RowStyle Font-Size="11px" />
                 <EmptyDataTemplate>
                     <asp:Label ID = "lblEmptyMessage" Text="No hay mensajes en la Bandeja" runat="server" />
                 </EmptyDataTemplate>
             </asp:GridView>
         </div>
