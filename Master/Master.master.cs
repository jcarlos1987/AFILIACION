...
public partial class Master_Master : System.Web.UI.MasterPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            if (Request.Cookies["ID_AFIL_TYPE"].Value == "0" || Request.Cookies["ID_AFIL_TYPE"].Value == "1" || Request.Cookies["ID_AFIL_TYPE"].Value == "11" || Request.Cookies["ID_AFIL_TYPE"].Value == "111")
            {
