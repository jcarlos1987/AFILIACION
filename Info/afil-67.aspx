<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterAdmonInfo.master" AutoEventWireup="true" Debug="true" CodeFile="afil-67.aspx.cs" Inherits="Info_afil_67" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="menu" Runat="Server">
    ...
    <li>
        ...
        <ul class="nav nav-second-level collapse in">  
            <li>
                <a class="active-menu" href="afil-67.aspx"><i class="fa fa-envelope-o fa-spin"></i>Afil-67</a>
            </li>
             <li>
                <a href="Afil-25.aspx"><i class="fa fa-envelope-o fa-spin"></i>Afil-25</a>
            </li>
        </ul>
    </li>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            <div class="row">
                    <div class="col-md-12">
                        ...
                        <h1 class="page-head-line" style="font-size:15px;">Administración de Información\ Afil-67 </h1>
                        <br />
                    </div>
                </div>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
         ...
         <h4>  <strong></strong></h4>
                <a href="#" class="list-group-item">
                                        <i class="fa fa-table fa-2x"></i> <strong>  Información detallada del AFIL-67</strong>

                    <asp:GridView ID="GridView1" CssClass="gridView table table-responsive" HeaderStyle-CssClass="gridViewHeader" PagerStyle-CssClass="gridViewPaginacion"  runat="server" AutoGenerateColumns="false">
                        <Columns>
                                            ...
                                            <asp:BoundField DataField="ciclo"  SortExpression="ciclo" HeaderText="Número de Ciclo"><ItemStyle ForeColor="Black" Width="20px" /></asp:BoundField>
                            <asp:BoundField DataField="fechaCiclo"  SortExpression="fechaCiclo" DataFormatString="{0:dd/MM/yyyy}" HeaderText="Fecha del Ciclo"><ItemStyle ForeColor="Black" Width="20px" /></asp:BoundField>
                            <asp:BoundField DataField="fechaCarga"  SortExpression="fechaCarga"  DataFormatString="{0:dd/MM/yyyy}" HeaderText="Fecha de Carga"><ItemStyle ForeColor="Black" Width="20px" /></asp:BoundField>
                            <asp:BoundField DataField="numRegistros"  SortExpression="numRegistros" DataFormatString="{0:0,000}" HeaderText="Total de Registros"><ItemStyle ForeColor="Black" Width="20px" /></asp:BoundField>
                        </Columns>
                    </asp:GridView>
